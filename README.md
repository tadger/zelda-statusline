<!-- og:image: assets/heart-statusline.jpg -->

# zelda-statusline

![zelda-statusline](assets/heart-statusline.jpg)
...
![zelda-statusline showing heart-container context health](assets/hearts.png)

(Hearts are Material Design Nerd Font glyphs.)
